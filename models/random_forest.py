...
TEST = TUNE = PLAYOFF_MAX_DEPTH = PLAYOFF_MAX_FEATURES = TUNE_SEASON_START = PREDICT_SEASON = TRAIN_SEASON_END = \
    ...
    OUTPUT_PRED_DEST = OUTPUT_STAT_DEST = OUTPUT_VALIDATION_DEST = OUTPUT_TUNE_DEST = OUTPUT_COLS =  OUTPUT_TUNE_STATS_DEST = None
STAB_CONST = 1e-10
...
def setup_model():
    global TEST, TUNE, PLAYOFF_MAX_DEPTH, PLAYOFF_MAX_FEATURES, PREDICT_SEASON, TUNE_SEASON_START, TRAIN_SEASON_END, \
        ...
        CONF_MAX_DEPTH, CONF_MAX_FEATURES, OUTPUT_VALIDATION_DEST
    ...
    OUTPUT_VALIDATION_DEST = config["output_validation_dest"]
...
def plot_rf_bar(playoff_acc, playoff_f1, conf_acc, conf_f1, dest):
    ...
    plt.tight_layout()
    plt.savefig(f"{dest}/rf_summary_bar.png", dpi=300)
    plt.close()
...
def run():
    ...
    plot_rf_bar(playoff_acc, playoff_f1, conf_acc, conf_f1, OUTPUT_VALIDATION_DEST)
